...
contract CounterScript is Script {
    ...
    function run() public {
        ...
        console.log(
            "allowance:",
            ERC20(WETH).allowance(address(alice), address(comet))
        );
        console.log("balance:", ERC20(WETH).balanceOf(address(alice)));
        comet.supplyTo(address(wallet), WETH, collateralAmount);
