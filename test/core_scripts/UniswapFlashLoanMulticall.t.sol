...
contract UniswapFlashLoanMulticallTest is Test {
    ...
    // Test #1: Using flash loan to arbitrage on Uniswap

    // Test #2: Using flash loan to liquidate account on Comet

    // Test #3: Using flash loan to buy ETH and stake on lido to get wstETH and return ETH by withdrawing from Comet
}