...
contract QuarkTest is Test {
    ...
    function testVmIncrementer() public {
    ...
    function testVmCallback() public {
    ...
    function testVmNoCallbacks() public {
    ...
    function testVmCounterScript() public {
    ...
    function testVmDirectIncrementer() public {
        bytes memory incrementer = new YulHelper().get("Incrementer.yul/Incrementer.json");
